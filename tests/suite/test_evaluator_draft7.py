# The official draft7 suite through the compiled evaluator (DESIGN.md D12,
...
def test_evaluator_case(case: SuiteCase) -> None:
    evaluator_case(case, DIALECT_DRAFT_07, REMOTES_DIR, RETRIEVAL_URI)
