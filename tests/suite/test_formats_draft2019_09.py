# The official draft2019-09 `optional/format` leg (DESIGN.md M7): every format
...
from json_schema_engine.formats import FORMATS_2019_09
from json_schema_engine.test_kit import SuiteCase, collect_suite_params, count_params

from .test_draft2019_09 import REMOTES_DIR, RETRIEVAL_URI, SUITE_DIR, UNSUPPORTED
...
def test_format_case(case: SuiteCase) -> None:
    formats_case(case, DIALECT_2019_09, FORMATS_2019_09, REMOTES_DIR, RETRIEVAL_URI)
