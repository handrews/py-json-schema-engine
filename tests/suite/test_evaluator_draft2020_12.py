# The official draft2020-12 suite through the compiled evaluator (DESIGN.md D12,
...
from json_schema_engine.core import DIALECT_2020_12
from json_schema_engine.test_kit import SuiteCase, count_params

from .test_draft2020_12 import (
...
def test_evaluator_case(case: SuiteCase) -> None:
    evaluator_case(case, DIALECT_2020_12, REMOTES_DIR, RETRIEVAL_URI)
